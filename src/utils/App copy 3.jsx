...
// ONLY PATCH: TextChat scrollable window restored (min-h-0 + maxHeight)
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 via-teal-50 to-white px-4 text-center relative">
      ...
      <div className="flex flex-col items-center gap-2 mb-4">
        ...
        {/* Status panel shows ONLY in local mode */}
        {sttMode === "local" && (
          <div className="mb-4">
...
// ====================================================
// TextChat — ONLY SCROLL FIX APPLIED
// ====================================================
function TextChat({ onBack }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-50 via-teal-50 to-white text-center px-4 relative">
      ...
      {/* =======================================================
           SCROLL FIX → min-h-0 + maxHeight + overflow-y-auto
         ======================================================= */}
      <div
        className="flex-1 min-h-0 overflow-y-auto w-full max-w-md mx-auto
                   bg-white rounded-2xl shadow-inner p-4 mb-4 mt-4"
        ...
        {messages.map((m, i) => (
          <div
            ...
            className={`mb-2 text-left ${
              m.role === "user" ? "text-blue-700" : "text-teal-700"
            }`}
          >
...
export default function App() {
  ...
  const defaultLabel =
    TRANS_MODE_DEFAULT === "0" ? "Front Model mode" : "Back Model mode";
